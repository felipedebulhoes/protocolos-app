...
def enrich_all_images():
    ...
    # Mapeamento de imagens para múltiplos protocolos adicionais
    images_mapping = {
        # Esfíncter Urinário Artificial
        "15_esfincter_urinario_artificial": [
            {
                "url": "/images/surgical/esfincter_artificial.jpg",
                "legend": "Componentes e posicionamento anatômico do Esfíncter Urinário Artificial (manguito uretral, balão regulador de pressão e bomba escrotal)."
            }
        ],
        # Sling Masculino
        "16_sling_masculino": [
            {
                "url": "/images/surgical/sling_masculino.jpg",
                "legend": "Posicionamento e ancoragem do sling suburetral masculino para compressão e suporte da uretra bulbar."
            }
        ],
        # Sling Feminino (Incontinência Urinária Feminina)
        ...
        # Hidrocelectomia Unilateral ou Bilateral
        "11_hidrocelectomia": [
            {
                "url": "/images/surgical/hidrocelectomia.jpg",
                "legend": "Abordagem cirúrgica da hidrocelectomia: ressecção ou plicatura (técnica de Lord / Jaboulay) do saco vaginal."
            }
        ],
